...
*-- Data Select 시 dd07t와 Join하여 데이터 가져오기
...
*-- 배송 출발일로부터 이틀 이상일때만 배송일 수정 가능

*    IF lv_day GT 2 AND gs_delivery-budat IS INITIAL.
*
*      CLEAR ls_style.
...
**     IV_SGTXT    =
**     IV_ANLN1    =
*      iv_wrbtr    = gs_horder-netwr
**     IV_MWSKZ    =
**     IV_DEBIT_SAKNR        =
**     IV_CREDIT_SAKNR       =
**     IV_EBELN    =
*      iv_vbeln_so = gs_delivery-vbeln_so
*      iv_partner  = gs_delivery-partner
*      iv_blart    = 'DR'.
